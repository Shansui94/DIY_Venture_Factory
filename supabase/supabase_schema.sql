...
begin
  ...
  -- 3. Check Material Availability (Optional: strict check or allow negative?)
  -- For this implementation, we allow negative stock but log it. 
  -- If you want to block negative stock, check here.
