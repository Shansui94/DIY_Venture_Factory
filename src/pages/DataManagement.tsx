            ...
            <div className="w-full md:w-80 lg:w-96 bg-[#0c0c0e] border-r border-white/5 flex flex-col z-10">
                ...
                <div className="flex-1 overflow-y-auto p-2 scrollbar-thin scrollbar-thumb-gray-800">
                    <button
                        ...
                        className="w-full mb-2 p-3 rounded-xl border border-dashed border-white/10 hover:border-indigo-500/50 hover:bg-indigo-500/5 text-gray-400 hover:text-indigo-400 text-sm font-bold flex items-center justify-center gap-2 transition-all"
                    >
                        <Plus size={16} /> Create New {activeTab.slice(0, -1)}
                    </button>
