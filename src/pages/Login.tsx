...
const Login: React.FC<LoginProps> = ({ onLogin }) => {
    ...
    const handleLoginProcess = async (emailToUse: string, passwordToUse: string) => {
        ...
        try {
            ...
            // Fallback: If App.tsx doesn't unmount us (switch view) quickly, force reload to pick up session.
            setTimeout(() => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gray-900">
            ...
            {/* Footer */}
            <div className="absolute bottom-6 text-center w-full z-10">
                <p className="text-gray-600 text-xs">© 2025 DIY Venture. Powered by Antigravity.</p>
            </div>
        </div>
    );
};
