        ...
        <div style={{ paddingBottom: '2rem' }}>
            ...
            <div className="glass-panel" style={{ padding: '2rem', marginBottom: '2rem' }}>
                ...
                <div style={{ paddingLeft: '1rem', borderLeft: '2px solid var(--accent-primary)' }}>
                    <h3 style={{ fontSize: '1.1rem', marginTop: '1rem' }} className="text-white font-bold">1. Start of Shift (开工)</h3>
                    <ul style={{ color: 'var(--text-secondary)', lineHeight: '1.6' }} className="list-disc pl-5">
                        ...
                        <li><strong>Check Schedule:</strong> Go to <em>My Shift</em> to confirm duty status.</li>
                    </ul>
                    ...
                    <h3 style={{ fontSize: '1.1rem', marginTop: '1rem' }} className="text-white font-bold">3. End of Shift (收工)</h3>
                    <ul style={{ color: 'var(--text-secondary)', lineHeight: '1.6' }} className="list-disc pl-5">
                        <li>Check total work duration in <em>My Shift</em>.</li>
                        <li>Log out to end session.</li>
                    </ul>
                </div>
            </div>
