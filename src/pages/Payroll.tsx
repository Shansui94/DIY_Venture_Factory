...
const Payroll: React.FC = () => {
    ...
    const payrollData: PayrollEntry[] = [
        { id: 1, employee: 'John Doe', role: 'Operator', shift: 'Night (12am-8am)', hours: 160, rate: 15.00, total: 2400.00, status: 'Pending' },
        { id: 2, employee: 'Jane Smith', role: 'Manager', shift: 'Morning (8am-4pm)', hours: 160, rate: 25.00, total: 4000.00, status: 'Paid' },
        { id: 3, employee: 'Mike Lee', role: 'Operator', shift: 'Evening (4pm-12am)', hours: 160, rate: 10.00, total: 1600.00, status: 'Pending' },
    ];
                        ...
                        <tbody className="text-sm text-gray-300">
                            {payrollData.map((item) => (
                                <tr key={item.id} className="border-b border-gray-800 hover:bg-white/5">
                                    ...
                                    <td className={`p-3 ${item.shift.includes('Night') ? 'text-purple-400' : item.shift.includes('Morning') ? 'text-blue-400' : 'text-orange-400'}`}>
                                        {item.shift}
                                    </td>
